                            ...
                            <section class="relative overflow-x-hidden" :class="pantry.featured_image_local ? 'py-2' : 'pb-2'">
                                ...
                                <div class="relative">
                                            ...
                                            <div class="relative border-b flex items-start">
                                                ...
                                                <div class="flex-1 py-4 pr-4 pl-2">
                                                    <span class="text-sm block">
                                                        <span class="font-bold" v-if="pantry.contacts[0].name" v-text="pantry.contacts[0].name"></span>
                                                    </span>
                                                    <span class="text-sm block">
                                                        <span v-if="pantry.contacts[0].contact_num" v-text="pantry.contacts[0].contact_num"></span>
                                                    </span>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="relative bg-gray-50" v-show="currentMenu == 'social'">
                                        <div class="relative border-b flex items-start" v-for="(account, index) in pantry.accounts[0]" v-if="account">
                                            <div class="w-16 flex-none text-blue-500 py-4 text-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                </svg>
